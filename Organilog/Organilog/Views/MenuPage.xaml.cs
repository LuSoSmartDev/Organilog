...
using Organilog.ViewModels.SystemSettings;
using System;
...
namespace Organilog
{
    ...
    public partial class MenuPage : ContentPage
    {
        ...
        private void InitMenu()
        {
            ...
            menuItems.Add(new HomeMenuItem { Id = MenuItemType.Issue, Title = TranslateExtension.GetValue("home_menu_title_issue"), Icon = "ic_menu_issue_black.png" });
            ...
            {
                menuItems.Add(new HomeMenuItem { Id = MenuItemType.Equipment, Title = TranslateExtension.GetValue("home_menu_title_equipment"), Icon = "ic_menu_equipment_black.png" });
                menuItems.Add(new HomeMenuItem { Id = MenuItemType.Products, Title = TranslateExtension.GetValue("home_menu_title_product"), Icon = "ic_menu_product_black.png" });
            }
