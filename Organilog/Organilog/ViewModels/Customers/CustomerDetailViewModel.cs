...
namespace Organilog.ViewModels.Customers
{
    public class CustomerDetailViewModel : TinyViewModel
    {
        ...
        {
            ListIntervention = App.LocalDb.Table<Intervention>().ToList().FindAll(i => i.UserId == Client.UserId && (i.FkClientServerId > 0 && i.FkClientServerId == Client.ServerId) && i.IsActif == 1);
