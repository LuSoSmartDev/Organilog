...
namespace Organilog
{
    ...
    public static class Settings
    {
        ...
        public static string LastSyncProduct
        {
            get => AppSettings.GetValueOrDefault(nameof(LastSyncProduct), default(string));
        ...
        //Last Sync Invoice 
        public static string LastSyncInvoice
        {
            get => AppSettings.GetValueOrDefault(nameof(LastSyncInvoice), default(string));
            set => AppSettings.AddOrUpdateValue(nameof(LastSyncInvoice), value);
        }

        public static string LastSyncEquipment
        {
            get => AppSettings.GetValueOrDefault(nameof(LastSyncEquipment), default(string));
            set => AppSettings.AddOrUpdateValue(nameof(LastSyncEquipment), value);
        }
        public static string LastSyncIssue
        {
            get => AppSettings.GetValueOrDefault(nameof(LastSyncIssue), default(string));
            set => AppSettings.AddOrUpdateValue(nameof(LastSyncIssue), value);
        }

        public static void RemoveLastIssue() => AppSettings.Remove(nameof(LastSync));
        ...
        public static double LogLat
        {
            get => AppSettings.GetValueOrDefault(nameof(LogLat), default(double));
            set => AppSettings.AddOrUpdateValue(nameof(LogLat), value);
        }

        public static void RemoveLogLat() => AppSettings.Remove(nameof(LogLat));

        public static double LogLong
        {
            get => AppSettings.GetValueOrDefault(nameof(LogLong), default(double));
            set => AppSettings.AddOrUpdateValue(nameof(LogLong), value);
        }

        public static void RemoveLogLong() => AppSettings.Remove(nameof(LogLong));

        public static long LastLogTime
        {
            get => AppSettings.GetValueOrDefault(nameof(LastLogTime), default(long));
            set => AppSettings.AddOrUpdateValue(nameof(LastLogTime), value);
        }

        public static void RemoveLastLogTime() => AppSettings.Remove(nameof(LastLogTime));
