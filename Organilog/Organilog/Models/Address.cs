...
namespace Organilog.Models
{
    ...
    public class Address : BaseModel
    {
        ...
        public string Adresse { get { return vAddress; }
            set {
                vAddress = value;
                OnPropertyChanged(nameof(RequiredAddressName), nameof(EnableSaveButton));
            }
        }
        ...
        public string FullAddress
        {
            get
            {
               ...
               return "#" + Code + " " + Societe +" "+ Adresse + " " + CodePostal + " " + Ville ;
        ...
        [Ignore]
        [JsonIgnore]
        public bool RequiredAddressName
        {
            get { return string.IsNullOrEmpty(Adresse); }
        }
